    ...
    accordion(
      ...
      accordion_panel("Colour",
        ...
        sliderInput(ns("opacity"),
                    span("Opacity",
                         tooltip(icon("info-circle"), "Move the lines to the inner points away from each other towards the nearest outer edge")),
                    value = c(25,75), step = 1, min = 0, max = 100),
